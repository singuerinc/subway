...
export default class WayPointSprite extends PIXI.Graphics {
    constructor({ model, color, dir }) {
        super();
        this._model = model;
        this._model.emitter.addListener('train:reserve', () => this._draw());
        this._model.emitter.addListener('train:enter', () => this._draw());
        this._model.emitter.addListener('train:leave', () => this._draw());
        this._color = color;
